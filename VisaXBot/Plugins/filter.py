...
from . import *
from VisaXBot.sql.filter_sql import get_filter, add_filter, remove_filter, get_all_filters, remove_all_filters
...
@bot.on(deadly_cmd(incoming=True))
...
@bot.on(deadly_cmd(pattern=r"filter (.*)"))
...
@bot.on(deadly_cmd(pattern="filters$"))
...
@bot.on(deadly_cmd(pattern="stop (.*)"))
...
@bot.on(deadly_cmd(pattern="rmallfilters$"))
