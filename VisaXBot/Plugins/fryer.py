...
@bot.on(visa_cmd(pattern="frybot$"))
...
@bot.on(visa_cmd(pattern=r"fry(?: |$)(.*)", outgoing=True))
...
async def deepfry(img: Image) -> Image:
    ...
    # Overlay red and yellow onto main image and sharpen the visa out of it
