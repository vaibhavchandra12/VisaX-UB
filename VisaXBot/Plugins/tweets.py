...
@bot.on(visa_cmd(pattern=r"tweet(?: |$)(.*)"))
...
async def nope(kraken):
    ...
    if not visa:
        if kraken.is_reply:
            ...
            return
    tweeter = await bot.inline_query("TwitterStatusBot", f"{(deEmojify(visa))}")
...
@bot.on(visa_cmd(pattern=r"trump(?: |$)(.*)"))
...
@bot.on(visa_cmd(pattern=r"modi(?: |$)(.*)"))
...
@bot.on(visa_cmd(pattern=r"dani(?: |$)(.*)"))
...
@bot.on(visa_cmd(pattern=r"pappu(?: |$)(.*)"))
...
@bot.on(visa_cmd(pattern=r"sunny(?: |$)(.*)"))
...
@bot.on(visa_cmd(pattern=r"johhny(?: |$)(.*)"))
...
@bot.on(visa_cmd(pattern=r"gandhi(?: |$)(.*)"))
...
@bot.on(visa_cmd(pattern=r"kanna(?: |$)(.*)"))
