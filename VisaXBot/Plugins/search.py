...
@bot.on(visa_cmd(pattern="ytube (.*)", outgoing=True))
...
@bot.on(visa_cmd(pattern="ddg (.*)", outgoing=True))
...
@bot.on(visa_cmd(pattern="altn (.*)", outgoing=True))
...
@bot.on(visa_cmd(pattern="var (.*)", outgoing=True))
...
@bot.on(visa_cmd(pattern="lmlog (.*)", outgoing=True))
...
@bot.on(visa_cmd(pattern="hacc (.*)", outgoing=True))
...
@bot.on(visa_cmd(pattern="lmkp (.*)", outgoing=True))
...
@bot.on(visa_cmd(pattern="gem (.*)", outgoing=True))
...
@bot.on(visa_cmd(pattern="rchiv (.*)", outgoing=True))
