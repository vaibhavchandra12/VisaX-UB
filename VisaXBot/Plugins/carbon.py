...
@bot.on(visa_cmd(outgoing=True, pattern="carbon(?: |$)(.*)"))
...
async def carbon_api(e):
    ...
    visa = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await visa.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await visa.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await visa.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by ∂єα∂ℓу кααℓ Bσт",
        force_document=True,
...
@bot.on(visa_cmd(outgoing=True, pattern="krb"))
@bot.on(sudo_cmd(pattern="krb", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    visa = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
...
@bot.on(visa_cmd(pattern=f"kar1(?: |$)(.*)", outgoing=True))
@bot.on(sudo_cmd(pattern="kar1(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    """ A Wrapper for carbon.now.sh """
    visa = await edit_or_reply(e, "🔲🔲🔲🔲🔲")
    ...
    await visa.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await visa.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
    ...
    os.remove("./carbon.png")
    # Removing carbon.png after uploading
    await visa.delete()  # Deleting msg


@bot.on(visa_cmd(pattern=f"kar2(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await visa.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await visa.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(visa_cmd(pattern=f"kar3(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await visa.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await visa.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(visa_cmd(pattern=f"kar4(?: |$)(.*)", outgoing=True))
@bot.on(sudo_cmd(pattern="kar4(?: |$)(.*)", allow_sudo=True))
async def carbon_api(e):
    if e.fwd_from:
        return
    """ A Wrapper for carbon.now.sh """
    vsia = await edit_or_reply(e, "🌚🌚🌚🌚🌚")
    ...
    await visa.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await visa.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(visa_cmd(pattern=f"rgbk2(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await visa.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await visa.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
@bot.on(visa_cmd(pattern=f"kargb(?: |$)(.*)", outgoing=True))
...
async def carbon_api(e):
    ...
    await visa.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await visa.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
