...
from VisaXBot.sql.welcome_sql import get_current_welcome, add_welcome, rm_welcome, update_welcome
from . import *
...
@bot.on(deadly_cmd(pattern="savewelcome(?: |$)(.*)"))
...
@bot.on(deadly_cmd(pattern="cleanwelcome$"))
...
@bot.on(deadly_cmd(pattern="showwelcome$"))
...
@bot.on(deadly_cmd(pattern="welcome_note$"))
